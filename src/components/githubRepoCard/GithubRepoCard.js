      ...
      <div className="repo-card-div" key={repo.node.id} onClick={() => openRepoinNewTab(repo.node.url)}>
        ...
        <div className="repo-stats">
          <div className="repo-left-stat">
            ...
            <span>
              <svg aria-hidden="true" className="octicon repo-star-svg" height="20" role="img" viewBox="0 0 10 16" width="12" fill="rgb(106, 115, 125)">
                <path
                  fill-rule="evenodd"
            ...
            <span>
              <svg aria-hidden="true" className="octicon repo-star-svg" height="20" role="img" viewBox="0 0 14 16" width="14" fill="rgb(106, 115, 125)" >
