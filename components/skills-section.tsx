...
export function SkillsSection() {
  ...
  return (
    <section id="skills" ref={ref} className="relative overflow-hidden bg-card/50 px-6 py-24 lg:px-24">
      ...
      <div className="mx-auto max-w-6xl">
        <h2 className={`anim-zoom animate-gpu mb-16 text-sm font-medium uppercase tracking-widest text-primary ${visibleClass}`}>
          Skills & Technologies
        </h2>
