    ...
    <>
      <section id="contact" ref={ref} aria-labelledby="contact-heading" className="relative overflow-hidden px-6 py-24 lg:px-24">
        ...
        <div className="mx-auto max-w-6xl">
          <h2 id="contact-heading" className={`anim-zoom animate-gpu mb-4 text-sm font-medium uppercase tracking-widest text-primary ${visibleClass}`}>
            Get in Touch
          </h2>
      ...
      <footer className={`anim-fade-up animate-gpu delay-600 border-t border-border px-6 py-8 text-center ${visibleClass}`}>
